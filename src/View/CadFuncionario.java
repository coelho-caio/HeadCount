...
import controller.CadastroDeFuncionariosController;
...
public class CadFuncionario extends JFrame implements ActionListener {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (fonte==btnSalvar) {
					CadastroDeFuncionariosController col = new CadastroDeFuncionariosController();
					col.recebeDados(txtNome.getText(), txtMatricula.getText(),
							txtCPF.getText(), txtDataNasc.getText(), txtCargo.getText(), 
							txtSalario.getText(), txtSetor.getText(), txtEPI.getText(), txtStatus.getText());
